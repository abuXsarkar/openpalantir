...
from database_lite import async_session_maker
from services.alert_system_lite import AlertSystem
...
async def get_sensitive_locations():
    ...
    from services.alert_system_lite import SENSITIVE_LOCATIONS
